...
Figures \ref{fig:bench1} and \ref{fig:bench2} shows the run-time comparison for machine learning algorithms using Spark MLlib in Jetstream and Chameleon, for predicting readmission likelihood, for 3 and 5 VM's respectively.

\begin{figure}[h]
\centering
\includegraphics[scale=0.25]{images/algoruntime3.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{images/algoruntime5.png}
